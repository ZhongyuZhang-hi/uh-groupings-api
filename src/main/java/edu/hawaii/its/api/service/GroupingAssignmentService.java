...
public class GroupingAssignmentService {
    ...
    /**
     * Get a Map of all owners with multiple ownerships and sources of ownership for those owners.
     * The value is an OwnerResult object containing the owner's details and list of paths that make them an owner.
     */
    public Map<String, OwnerResult> getDuplicateOwnerResults(String currentUser, String groupPath) {
        logger.info(String.format("getDuplicateOwnerResults; currentUser: %s; groupPath: %s;",
                currentUser, groupPath));
        ...
        Map<String, OwnerResult> existingUhUuids = new HashMap<>();
        Map<String, OwnerResult> duplicates = new HashMap<>();
